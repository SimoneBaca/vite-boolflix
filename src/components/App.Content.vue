...
<div class="container my-4">
    <div class="row">
        ...
        <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="Search films or series  " aria-label="Recipient's username" aria-describedby="button-addon2"
      v-model="search" @keyup.enter="ricercaTutto(search)">
      <button class="btn btn-outline-secondary" type="button" id="button-addon2" @click="ricercaTutto(search)">Search</button>
